...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Ragon.New 2.0',
  SIGNIN_SUBHEADING: 'To use Ragon you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Ragon, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use Ragon a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
